            ...
            >
                ...
                <header className="sticky top-0 z-50 bg-white/80 dark:bg-neutral-900/80 backdrop-blur-xl border-b border-neutral-200/50 dark:border-neutral-800/50">
                    <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h1 className="text-lg font-bold tracking-tight text-neutral-900 dark:text-white">Speedtest Ultra</h1>
                                <p className="text-[10px] uppercase font-bold text-neutral-400 tracking-wider">Pro Diagnostics</p>
                            </div>
                        </div>
                ...
                <main className="max-w-7xl mx-auto px-4 sm:px-6 py-8 space-y-8">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        {/* Download Card */}
                        <GlassCard className="p-8 relative overflow-hidden" glow active={status === 'download'}>
                            ...
                            <div className="relative z-10 mb-8">
                                <div className="text-7xl font-light tracking-tighter text-neutral-900 dark:text-white tabular-nums">
                        ...
                        {/* Upload Card */}
                        <GlassCard className="p-8 relative overflow-hidden" glow active={status === 'upload'}>
                            <div className="flex justify-between items-start mb-8 relative z-10">
                                <div className="flex items-center gap-3">
